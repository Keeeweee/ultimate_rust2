...
and is commonly used for cultivars of Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita maxima,
...
Recipies will be coming soonish
**/
pub struct Pumpkin {
    /// `roundess` is a percentage
    pub roundness: f32,
    /// `orangeness` must be a number between 8 and 27
    pub orangeness: i32,
}
